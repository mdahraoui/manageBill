...
public class Tableau {
	public static void main(String[] args) {
		...
		// En Java, un tableau est un bien meilleur choix pour stocker une séquence de
		...
		// En Java, vous obtenez un tableau à deux dimensions en fournissant le nombre
		// de lignes et de colonnes.
		// Par exemple, new int [7] [3] est un tableau avec sept lignes et trois
		// colonnes.
		// Vous stockez une référence à un tel tableau dans une variable de type int []
		// [].
		// Voici une déclaration complète d'un tableau à deux dimensions, adapté pour
		// contenir nos données de
 ...
 *
 * Dans un tableau, le premier element a l'indice 0 et celui du dernier element
 * est (taille - 1)
 *
